...
// KEDA v2.19.0 declares k8s.io dependencies at higher versions (e.g. k8s.io/client-go v1.5.2,
// k8s.io/api v0.35.0) with local replace directives pinning them to v0.34.3.
// Since Go replace directives do not propagate to consuming modules, we must add
// matching replacements here to keep the k8s.io modules on the v0.34.x line.
replace (
